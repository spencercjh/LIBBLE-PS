...
train_data_file = ' /home/spencercjh/codes/dataset/rcv1/rcv1_train.binary '  # train data path.
partition_directory = "/home/spencercjh/codes/dataset/rcv1/8"
...
os.system(
    'mpirun -n ' + n_trainers + ' -f ' + machine_file + ' ./svm ' + ' -n_servers ' + n_servers + '-n_workers ' +
    n_workers + ' -n_epoches' + n_epoches + ' -n_iters' + n_iters + ' -n_cols' + n_cols + ' -n_rows' + n_rows +
    ' -test_data_file ' + test_data_file + ' -train_data_file ' + train_data_file + ' -partition_directory ' +
    partition_directory + ' -rate ' + rate + ' -lambda ' + lam + ' -param_init ' + param_init)
